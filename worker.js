...
async function enhanceHtml(response) {
  ...
  return new Response(withManifest.replace('</body>', APP_ENHANCEMENTS + AVATAR_LEAK_GUARD + FILE_UPLOAD_FALLBACK + '</body>'), { status: response.status, headers: { ...Object.fromEntries(response.headers), 'Cache-Control': 'no-store', 'X-BlueTalk-Source': 'genspark-ui-cloudflare-kv' } });
}
