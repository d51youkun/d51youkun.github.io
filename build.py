...
def get_merged_js() -> str:
    ...
    for extra in ("v6.js", "v7.js", "v8.js", "v9.js"):
        p = ROOT / extra
        if p.exists():
...
def export_version_folder(pages_html: str, version: str) -> None:
    ...
    for name in ("app.js", "features.js", "v4.js", "v6.js", "v7.js", "v8.js", "v9.js", "body.html", "styles.css", "build.py"):
        src = ROOT / name
        if src.exists():
            shutil.copy2(src, out_dir / name)
...
def main() -> None:
    ...
    export_version_folder(pages, "v9")
